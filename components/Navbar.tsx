  ...
  const navLinks = session
    ? [
        ...
        },
        {
          ...
          subItems: [
            { href: "/play/online", label: "Play Online", icon: <Gamepad2 size={14} /> },
            { href: "/play/bots", label: "Play Bots", icon: <Bot size={14} /> },
            { href: "/play/coach", label: "Play Coach", icon: <Sparkles size={14} /> },
            { href: "/stats", label: "Stats", icon: <TrendingUp size={14} /> },
            { href: "/tournaments", label: "Tournaments", icon: <Trophy size={14} /> },
            { href: "/variants", label: "Variants", icon: <Shuffle size={14} /> },
            { href: "/history", label: "Game History", icon: <History size={14} /> },
          ],
        },
        {
          href: "/puzzles",
